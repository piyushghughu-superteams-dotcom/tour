...
const navItems = [
  ...
  },
  {
    group: "Explore",
    items: [
      { path: "destinations", label: "Destinations", icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z" },
        ...
        <main className="flex-1">
          <div className="sticky top-0 z-20 border-b border-white/50 bg-white/60 backdrop-blur-xl">
            <div className="mx-auto flex max-w-[1600px] items-center justify-between px-5 py-4 md:px-8">
              ...
              <div className="flex items-center gap-3">
                <span className="hidden items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-700 sm:inline-flex">
                  <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-500" />
                  AI Online
                </span>
                <button
                  onClick={handleEditProfile}
                  className="flex h-10 min-w-10 items-center justify-center rounded-full bg-slate-950 px-3 text-xs font-bold text-white"
          ...
          <div className="mx-auto max-w-[1600px] px-5 py-6 md:px-8 md:py-8">
            <Routes>
              ...
              <Route path="planner" element={<ComingSoon title="AI Trip Planner" />} />
